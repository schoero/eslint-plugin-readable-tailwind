import { getConflictingClasses } from "readable-tailwind:async:conflicting-classes.sync.js";
import {
...
const DOCUMENTATION_URL = "https://github.com/schoero/eslint-plugin-readable-tailwind/blob/main/docs/rules/no-conflicting-classes.md";
